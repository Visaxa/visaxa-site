...
This becomes clearer when looking at 
<a href="/blog/what-breaks-first-when-scheduling-scales" className="subtle-link">what actually breaks first in scheduling systems</a>.
