# A10 Draft — Is Your Salon CRM Actually the Problem?
...
- Status: promoted to an uncommitted publication candidate
- Evidence basis: `docs/research/evidence/A10/EVIDENCE_PACK.md`
- Note: this working draft preserves the complete narrative used to create the publication candidate. Public metadata and component markup live in the MDX candidate.
